...
Now we have to configure our product. Open the product file (_example.product_) by double clicking. Click on new and select the plug-in _io.rage5474.rcp.example.ui.plugin_ in the field *Defining Plug-in* and enter a *Product ID*, e.g. _rcp_product_. Click *Finish*.
