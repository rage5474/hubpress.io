...
First we create the plug-in _io.rage5474.rcp.example.ui.plugin_ with our simple application logic. Therefore we use the integrated plug-in generator. Go to *File -> New -> Other* and select *Plug-in Project*.
...
So start again with *File -> New -> Other* and select *Feature Project*. Enter the feature name _io.rage5474.rcp.example.ui.feature_ and click *Finish*.
